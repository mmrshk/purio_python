    ...
    def calculate_health_scores(self, product: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            if isinstance(parsed_ingredients, dict):
                ...
                # Don't calculate final score if extracted > matched (incomplete data)
            ...
            if final_score is not None and product_id:
                has_high_risk = self._check_product_high_risk_additives(product_id)
                scores['display_score'] = min(final_score, 49) if has_high_risk else final_score
